  ...
  return (
    <main>
      <section
        ...
        <div className="bg-white bg-opacity-10 backdrop-blur-lg rounded-xl shadow-inner p-4 sm:p-6 text-center text-white px-4 sm:px-6 border-[1px] border-white drop-shadow-xl backdrop-brightness-75">
          <h1 className="text-4xl sm:text-5xl md:text-6xl mb-4 sm:mb-6 drop-shadow-md font-aoboshi">
            genesis
          </h1>
          <h2 className="text-3xl sm:text-4xl mb-3 sm:mb-4 font-bold drop-shadow-md">
            Tech Install/Support
          </h2>
          <p className="text-lg sm:text-xl md:text-2xl font-light mb-6 sm:mb-8 drop-shadow-2xl">
          ...
          <MotionLink
            ...
            className="inline-block py-2 sm:py-4 px-6 sm:px-8 text-lg sm:text-xl bg-genesis-orange text-white font-bold rounded-full transition duration-300 hover:bg-orange-700 drop-shadow-md"
            to="/subscription">
            Subscribe Now
          </MotionLink>
        </div>
      ...
      <section className="bg-white py-20">
        <div className="container mx-auto px-4 sm:px-8">
          ...
          <div className="grid grid-cols-1 gap-4 sm:gap-8 max-w-xs sm:max-w-3xl mx-auto">
